...
*/
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3932679059165622226L;
	private int hNum;
	private String name;
	...
	public HotelDto(int hNum, String name, String checkIn, String checkOut, String location, int price, int room) {
		super();
		this.hNum = hNum;
		this.name = name;
	...
	public String toString() {
		return "HotelDto [hNum=" + hNum + ", name=" + name + ", checkIn=" + checkIn + ", CheckOut=" + CheckOut
