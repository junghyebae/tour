...
public class AirplainDto implements Serializable {
	...
	private static final long serialVersionUID = -2968365247267142994L;
	...
	public String toString() {
		return "AirplainDto [a_num=" + a_num + ", a_name=" + a_name +
				", a_seat_one=" + a_seat_one + ", a_seat_two="
				+ a_seat_two + ", a_seat_three=" + a_seat_three +
				", a_location_s=" + a_location_s + ", a_location_e="
				+ a_location_e + ", a_time_s=" + a_time_s + 
				", a_time_e=" + a_time_e + ", a_price=" + a_price + "]";
	}
