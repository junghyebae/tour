...
<ul class="area">
	<li class="item" style="width:50%; background-color: #66ccff;"><a href="#" id="buycountRank">구매순</a></li>
	<li class="item" style="width:50%; background-color: #1ab2ff;"><a href="#" id="readcountRank">조회수순</a></li>
</ul>

<div id="showRank">
	<table style="text-align: center;">
	<col width="151.5"><col width="151.5">
	<!-- 기본적으로 상품구매순위를 보여줌 -->
	<%
	...
	List<PackageDto> packlist = packDao.rankList();
	%>
	<%
	if(packlist !=null && packlist.size()>1){
...
$(document).ready(function() {
	$("#readcountRank").click(function() {
		//alert("클릭됨");
		$.ajax({
			type:"post",
			url:"../main/ajax_readcount.jsp",
			data:{
				type: "readcount",
			},
			success:function(data){
				$("#showRank").html(data);
				$("#readcountRank").prop("style","color:yellow");
				$("#buycountRank").removeAttr("style");
			}
		})
	});
	$("#buycountRank").click(function() {
		//alert("클릭됨");
		$.ajax({
			type:"post",
			url:"../main/ajax_readcount.jsp",
			...
			success:function(data){
				$("#showRank").html(data);
				$("#buycountRank").prop("style","color:yellow");
				$("#readcountRank").removeAttr("style");
			}
		})
	});
}); 
